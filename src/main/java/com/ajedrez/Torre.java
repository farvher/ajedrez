...
public class Torre extends AbstractFicha implements Ficha {
	...
	/**
	 * movimiento de la torre, debe ser lineal en x o lineal en y
	 * */
	@Override
	public boolean validarMovimiento(int initPosX, int initPosY, int futPosX, int futPosY) {
		...
		if (init[0]==movement[0] || init[1]==movement[1]){
			return true;
